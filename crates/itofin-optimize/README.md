...
hook and validated inputs. Solvers arrive one ticket at a time; this crate today
holds the contracts they share and has no public `minimize` entry point yet.
